...
<body>
	...
	<div class="container">
		...
		<div id="id_wrap" class="idwrap">
			<c:if test="${empty member}">
				<form method="post" action="m_idfindokForm"
					...
					<div class="input-div pass">
						...
						<div class="div">
							<input name="birth" id="birth" type="text" placeholder=생년월일6자리
								class="input">
						</div>
					</div>
			...
			<c:if test="${!empty member}">
				<form method="post" action="m_idfindokForm"
					onsubmit="return check()">
					<h2 class="id_title2">조회 결과</h2>
					<div class="input-div findid">
						<div class="i">
							<i class="fas fa-user"></i>
						</div>
						<div class="div" style="font-size: 1.5rem;" >
						조회된 ID: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${member.id}</div>
					</div>
					<div id="id_close2">
